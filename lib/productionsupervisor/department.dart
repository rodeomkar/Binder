...
class _DepartState extends State<Depart> with RouteAware{
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text("Department Complaints",style: TextStyle(fontFamily: 'Roboto', color: Color(0xFF1467B3), fontSize: 18,fontWeight: FontWeight.w500)),
              ),
